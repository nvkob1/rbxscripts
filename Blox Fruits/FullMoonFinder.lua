...
function CheckMoonAndExecute()
    ...
    CodeServer = 'game:GetService("ReplicatedStorage").__ServerBrowser:InvokeServer("teleport", "'..tostring(game.JobId)..'")'
...
function Hop()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/nvkob1/rbxscripts/refs/heads/main/Blox%20Fruits/ServerHopper.lua"))()
end
